...
#include "../../Shell/commandhandler.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_commandHandler_t, stringdata) + ofs \
...
void *commandHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_commandHandler.stringdata))
